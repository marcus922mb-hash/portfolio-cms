...
export default async function PanelWordPressPage() {
  ...
  return (
    <>
      <div className="crm-page-header">
        <div>
          <h1 className="crm-page-title">WordPress</h1>
          <p className="crm-page-desc">Zarządzanie połączeniami z witrynami WordPress</p>
        </div>
      ...
      {error ? (
        ...
        <EmptyState
          ...
          description="Dodaj pierwsze połączenie z witryną WordPress, aby zacząć zarządzać jej treścią."
          action={
            <Link href="/panel/wordpress/nowe" className="crm-btn crm-btn--primary crm-btn--sm">
              <Plus size={13} />
              Dodaj połączenie
